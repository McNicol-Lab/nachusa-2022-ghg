---
title: "Nov 2023 Prelim Visualizations"
...
flux_nov <- read_csv("./data/231111/231111_fluxes.csv")
photo_nov <- read_csv("./data/231111/231111_photosynthesis.csv")
...
```{r combine-data}
all_nov <- bind_rows(flux_nov, photo_nov)
...
```{r write-csv, eval = F}
write_csv(all_nov, "data/231111/full_nov_dataset.csv")
```
