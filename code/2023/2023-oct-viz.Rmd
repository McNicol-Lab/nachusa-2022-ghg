---
title: "Oct 2023 Prelim Visualizations"
...
flux_oct <- read_csv("./data/231014/231014_fluxes.csv")
photo_oct <- read_csv("./data/231014/231014_photosynthesis.csv")
...
```{r combine-data}
all_oct <- bind_rows(flux_oct, photo_oct)
...
```{r write-csv, eval = F}
write_csv(all_oct, "data/231014/full_oct_dataset.csv")
```
