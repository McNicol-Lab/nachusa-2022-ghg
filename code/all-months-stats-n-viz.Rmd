...
full_data <- full_data %>%
  ...
  mutate(ecosystem = fct_relevel(ecosystem, levels = c(
                                 ...
                                 "NW",
                                 "SW")),
         gas = fct_relevel(gas, levels = c(
                                 "co2",
                                 "ch4",
                                 "n2o")),
         transect = fct_relevel(transect, levels = c("high",
                                                     "mid",
                                                     "low"))) 
```
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/all_flux_n_moisture.png", width = 30, height = 12)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/moisture_n_date.png", width = 30, height = 12)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/EW_weird_temps.png", width = 7, height = 5)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/all_flux_n_temp.png", width = 30, height = 12)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/temp_n_date.png", width = 30, height = 12)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/co2_temp_date_eco.png", width = 30, height = 12)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/ch4_temp_date_eco.png", width = 30, height = 12)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/n2o_temp_date_eco.png", width = 30, height = 12)
...
mod_data %>%
  ...
  theme_bw() +
  theme(text = element_text(size=20))
ggsave("plots/temp_n_moisture.png", width = 30, height = 12)
